...
public class ItemTemplate extends Item {
	...
	public void registerIcons(IconRegister register) {
		itemIconBlank = register.registerIcon(ModInfo.TEXTURE_LOCATION + ":"
				+ ItemInfo.TEMPLATE_ICON_BLANK);
		itemIconEnch = register.registerIcon(ModInfo.TEXTURE_LOCATION + ":"
				+ ItemInfo.TEMPLATE_ICON_ENCH);
	}
	...
	public void addInformation(ItemStack itemstack, EntityPlayer player,
		...
		if (itemstack.getItemDamage() > 0)
			info.add("Charge: " + itemstack.getItemDamage());
	}
